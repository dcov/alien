...
part 'listing.msg.dart';

typedef _TransitionListingEffectFactory = Effect Function(Page page);

@action transitionListing(_, {
      @required Listing listing,
      @required ListingStatus to,
      @required _TransitionListingEffectFactory effectFactory
    }) {
...
@action transitionListingSuccess<TD extends ThingData>(_, {
      @required Listing listing,
      @required ListingStatus to,
      @required ListingData<TD> data,
      @required _ThingFactory<TD> thingFactory
    }) {
...
@action transitionListingFailure(_) {
  // TODO: implement
}
